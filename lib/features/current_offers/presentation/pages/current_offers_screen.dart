...
import 'package:budget/features/current_offers/presentation/widgets/current_offers_screen_item_widgets.dart';
...
class CurrentOffersScreen extends StatefulWidget {
  const CurrentOffersScreen({super.key});
                  ...
                  return GridView.builder(
                    ...
                    gridDelegate:
                        const SliverGridDelegateWithFixedCrossAxisCount(
                          ...
                          mainAxisSpacing: 16,
                          childAspectRatio:
                              0.52, // Adjusted for taller vertical card
                        ),
                    itemCount: cars.length,
                    itemBuilder: (context, index) {
                      return CurrentOfferScreenItem(car: cars[index]);
                    },
                  );
                },
              ),
